...
{
    public const uint MODULE_ID = 2;
    public const uint HASH_CODE = 1213898400;
    ...
    public interface IResponder
    {
        ...
        Msg Test(Msg msg);
        void Test(List<FixedArray<int, ArrayLength_10>> ar);
    };
    ...
    public class Processor : CrossCall.IProcessor
    {
        ...
        void OnTest_int_A10_A(CrossCall.IContext context)
        {
            List<FixedArray<int, ArrayLength_10>> ar = new List<FixedArray<int, ArrayLength_10>>();

            Serialize.Utility.Read(context.Param, ref ar);
