...
namespace LitJson
{
    ...
    {
        private static HashSet<string> InterningKeyStrings = new HashSet<string> { "x", "y", "z", "w" };
        ...
        private void ProcessSymbol()
        {
            ...
            {
                if (InterningKeyStrings.Contains(lexer.StringValue))
                {
                    token_value = string.Intern(lexer.StringValue);
                }
                else
                {
