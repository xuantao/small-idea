...
#line 37 "parser.y" // lalr1.cc:371
namespace  EzAquarii  {
#line 82 "parser.h" // lalr1.cc:371
    ...
    , location (other.location)
  {
    ...
    {
      case 11: // command
        value.copy<  EzAquarii::Command  > (other.value);
        break;
    ...
    , location (l)
  {
    ...
    {
      case 11: // command
        value.copy<  EzAquarii::Command  > (v);
        break;
  ...
  template <typename Base>
   Parser ::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const  EzAquarii::Command  v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
   ...
   Parser ::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    {
      case 11: // command
        value.move<  EzAquarii::Command  > (s.value);
        break;
...
#line 962 "parser.h" // lalr1.cc:371
