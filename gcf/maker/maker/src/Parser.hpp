...
#line 54 "Parser.hpp" // lalr1.cc:371
...
namespace  gcf  {
#line 77 "Parser.hpp" // lalr1.cc:371
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_S_PLUS (const location_type& l);
    ...
    static inline
    symbol_type
    make_S_SLASH (const location_type& l);

    static inline
    symbol_type
    make_S_COLON (const location_type& l);
    ...
    static inline
    symbol_type
    make_S_ASSIGN (const location_type& l);

    static inline
    symbol_type
    make_S_LBRACK (const location_type& l);

    static inline
    symbol_type
    make_S_RBRACK (const location_type& l);

    static inline
    symbol_type
    make_S_LBRACE (const location_type& l);

    static inline
    symbol_type
    make_S_RBRACE (const location_type& l);
   ...
   Parser ::make_END (const location_type& l)
  {
   ...
   Parser ::symbol_type
   Parser ::make_S_LPAREN (const location_type& l)
  {
   ...
   Parser ::symbol_type
   Parser ::make_S_RPAREN (const location_type& l)
  {
   ...
   Parser ::symbol_type
   Parser ::make_S_STAR (const location_type& l)
  {
   ...
   Parser ::symbol_type
   Parser ::make_S_PLUS (const location_type& l)
  {
    return symbol_type (token::TOK_S_PLUS, l);

  }

   Parser ::symbol_type
   Parser ::make_S_COMMA (const location_type& l)
  {
   ...
   Parser ::symbol_type
   Parser ::make_S_MINUS (const location_type& l)
  {
   ...
   Parser ::symbol_type
   Parser ::make_S_DOT (const location_type& l)
  {
   ...
   Parser ::symbol_type
   Parser ::make_S_SLASH (const location_type& l)
  {
    return symbol_type (token::TOK_S_SLASH, l);

  }

   Parser ::symbol_type
   Parser ::make_S_COLON (const location_type& l)
  {
    return symbol_type (token::TOK_S_COLON, l);

  }

   Parser ::symbol_type
   Parser ::make_S_SEMICOLON (const location_type& l)
  {
   ...
   Parser ::symbol_type
   Parser ::make_S_ASSIGN (const location_type& l)
  {
    return symbol_type (token::TOK_S_ASSIGN, l);

  }

   Parser ::symbol_type
   Parser ::make_S_LBRACK (const location_type& l)
  {
    return symbol_type (token::TOK_S_LBRACK, l);

  }

   Parser ::symbol_type
   Parser ::make_S_RBRACK (const location_type& l)
  {
    return symbol_type (token::TOK_S_RBRACK, l);

  }

   Parser ::symbol_type
   Parser ::make_S_LBRACE (const location_type& l)
  {
    return symbol_type (token::TOK_S_LBRACE, l);

  }

   Parser ::symbol_type
   Parser ::make_S_RBRACE (const location_type& l)
  {
    return symbol_type (token::TOK_S_RBRACE, l);
