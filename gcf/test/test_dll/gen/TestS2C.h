...
public:
    ...
    static const int32_t HASH_CODE = 850647883;
    ...
    public:
        ...
        virtual void Test(const std::array<bool, 2>& v) = 0;
    ...
    public:
        ...
        void Test(const std::array<bool, 2>& v);
    ...
    protected:
        ...
        void OnTest_bool_A2(cross_call::IContext* context);
